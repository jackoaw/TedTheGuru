...
<body>
	...
	?>
				<h2>Edit user privileges here</h2><br>
				<form method="POST" action="<?php echo BASE_URL;?>account/privileges?action=submit">
				Account ID:<br>
				<input type="text" name="user#"><br>
				Admin:<br>

                    <select name="user-privileges" id="user-privileges" onchange="" size="1">
                      <option value="" disabled selected>Priviliges</option>
	...
	?>
				<h2>Delete user here</h2><br>
				<form method="POST" action="<?php echo BASE_URL;?>account/delete?action=submit">
				Account ID:<br>
				<input type="text" name="user#"><br>
				<br><input type="submit" value="Submit">
				</form> 
