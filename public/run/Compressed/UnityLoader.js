        ...
        return function e(t, n, o) {
            ...
            8: [function(e, t, n) {
                ...
                function f(e, t) {
                    ...
                    return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || m !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = fe, z) : (p -= e.avail_in, m -= e.avail_out, e.total_in += p, e.total_out += m, n.total += m, n.wrap && m && (e.adler = n.check = n.flags ? v(n.check, a, m, e.next_out - m) : g(n.check, a, m, e.next_out - m)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === p && 0 === m || t === M) && xe === R && (xe = B), xe)
                }
            ...
            9: [function(e, t, n) {
                ...
                t.exports = function(e, t, n, p, m, w, b, g) {
                    ...
                    if (e === s ? (T = G = b, S = 19) : e === l ? (T = u, P -= 257, G = c, j -= 257, S = 256) : (T = f, G = h, S = -1), Z = 0, D = 0, F = L, x = w, B = z, I = 0, y = -1, O = 1 << z, _ = O - 1, e === l && O > a || e === d && O > r) return 1;
                    for (var H = 0;;) {
    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                }, new t(0, 8459852, 0, 0).open("GET", "/data.unity3d"), new t(8459852, 8459873, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(8459873, 8463224, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(8463224, 9996456, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(9996456, 11492516, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(11492516, 11520141, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_Run.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, l ? (n(l), l = null) : d = n
            }
            var o;
